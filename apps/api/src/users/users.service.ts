...
export class UsersService {
  ...
  async setIntendedRole(
    ...
    await this.syncCurrentUser(clerkUserId);
    return this.usersRepository.setIntendedRole(clerkUserId, role);
  }

  async clearIntendedRole(clerkUserId: string): Promise<void> {
    await this.usersRepository.clearIntendedRole(clerkUserId);
  }
}
